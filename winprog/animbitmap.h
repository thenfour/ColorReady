...
public:
  ...
  void Rect2(long l, long t, long width, long height, RgbPixel c)
  {
    RgbPixel* pbuf = &m_pbuf[(t * m_x) + l];
    // fill downwards
  ...
  // b and r are not drawn
  void SafeRect2(long l, long t, long width, long height, RgbPixel c)
  {
		if(l < 0)
		{
			width += l;
    ...
    clamp(width, 0, m_x - l);
    clamp(height, 0, m_y - t);
    Rect2(l, t, width, height, c);
  }
